...
/**
 * @author GaoMing
 * @date 2021/10/13 - 20:40
 */

// @Component 组件实例 @Service @Dao @Controller
@Service
public class SeckillServiceImpl implements SeckillService {
    ...
    // md5盐值字符串，用于混淆
    private final String slat = "sl<>fejji//.,e0258@##ER$RTR940^^TRT&??5~~wjsSFEREapi";
    ...
    public SeckillExecution executeSeckill(long seckillId, long userPhone, String md5) throws SeckillCloseException, RepeatKillException, SeckillException {
        ...
        try {
            ...
            if(insertCount <= 0){
                ...
                int updateCount = seckillDao.reduceNumber(nowTime, seckillId);
                if(updateCount <= 0){
                    // 没有更新到记录，秒杀结束
